...
{
  "resultado": {
    "process_id": "202601281634535_direct_gpt_gpt-4o-mini",
    "ncm": [
      "0101.21.00",
      "0101.29.00"
    ]
...
3. Executa polling até que o status do processo seja `FINISHED`.
4. Retorna a lista de NCMs encontrados e o `process_id` do processo.
